...
- Coordinate changes to shared build/configuration files and respect module boundaries in
  `docs/architecture/ownership.md`.
- Run `./script/lint.sh`, package tests, and the relevant Xcode build before handing work to a
  reviewer.
