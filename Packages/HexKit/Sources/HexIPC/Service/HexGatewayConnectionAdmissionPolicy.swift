...
public struct HexGatewayConnectionAdmissionPolicy: Equatable, Sendable {
  ...
  public static var productionApplicationTeamIdentifier: String {
    HexSigningIdentity.current?.teamIdentifier ?? "UNCONFIGURED"
  }

  public static var productionCodeSigningRequirement: String {
    HexSigningIdentity.current?.applicationCodeSigningRequirement ?? "never"
  }
