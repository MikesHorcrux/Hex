...
public actor KeychainHexSecretStore: HexSecretStore {
  ...
  /// An unsigned process gets an unauthorized group, never an implicit default Keychain group.
  public static var defaultAccessGroup: String {
    HexSigningIdentity.current?.residentKeychainAccessGroup ?? "Hex.unconfigured.resident"
  }
