...
`TEAMID.com.lunarmothstudios.Hex.resident` group, embeds the development profile that
...
`TEAMID`. This is a local development signing and credential-sharing boundary.
