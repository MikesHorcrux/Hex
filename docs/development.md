...
[source layout](architecture/source-layout.md) before changing code. Use an isolated feature branch
and worktree from the public default branch. Preserve unrelated work and configure your own signing
team as described in [getting started](start.md).
