...
## Packages/HexKit/Sources/HexCore/Coding

| Source file | Leading source documentation |
| --- | --- |
| [CodingWorkspaceControlling.swift](../../../Packages/HexKit/Sources/HexCore/Coding/CodingWorkspaceControlling.swift) | — |
| [CodingWorkspaceStorage.swift](../../../Packages/HexKit/Sources/HexCore/Coding/CodingWorkspaceStorage.swift) | — |
| [GitWorkspaceSnapshot+Preview.swift](../../../Packages/HexKit/Sources/HexCore/Coding/GitWorkspaceSnapshot+Preview.swift) | — |
...
## Packages/HexKit/Sources/HexCore/ProcessSessions
...
| [ProcessSessionPage.swift](../../../Packages/HexKit/Sources/HexCore/ProcessSessions/ProcessSessionPage.swift) | — |
| [ProcessSessionRecord.swift](../../../Packages/HexKit/Sources/HexCore/ProcessSessions/ProcessSessionRecord.swift) | — |
| [ProcessSessionScope.swift](../../../Packages/HexKit/Sources/HexCore/ProcessSessions/ProcessSessionScope.swift) | — |
| [ProcessSessionStorage.swift](../../../Packages/HexKit/Sources/HexCore/ProcessSessions/ProcessSessionStorage.swift) | — |
...
| [HexSigningIdentity.swift](../../../Packages/HexKit/Sources/HexCore/Resident/HexSigningIdentity.swift) | The team boundary comes from this process's validated code signature, never user defaults or an environment variable. Unsigned and ad hoc processes have no resident signing identity. |

## Packages/HexKit/Sources/HexCore/Tasks
...
| [ToolCallValidationError.swift](../../../Packages/HexKit/Sources/HexCore/Tools/ToolCallValidationError.swift) | A host tool rejected model arguments before authorization or dispatch, including a definitely absent executable reference. Never use for permission, transport, or execution errors. |
...
| [ToolExecutionOutcome.swift](../../../Packages/HexKit/Sources/HexCore/Tools/ToolExecutionOutcome.swift) | Host-adapter evidence. A known command failure is distinct from an unknown dispatch outcome. |
