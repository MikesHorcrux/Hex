...
| --- | ---: | --- |
| [Hex](Hex.md) | 220 | macOS app composition, observable models, services and SwiftUI views. |
...
| [HexCoreTests](HexCoreTests.md) | 17 | Focused test target; consult suites for exercised boundaries. |
| [HexGatewayCommand](HexGatewayCommand.md) | 1 | HexGateway executable entry and concrete provider injection. |
| [HexGatewayKit](HexGatewayKit.md) | 78 | Resident composition, lifecycle, heartbeats and self-knowledge. |
| [HexGatewayTests](HexGatewayTests.md) | 35 | Focused test target; consult suites for exercised boundaries. |
...
| [HexPersistenceTests](HexPersistenceTests.md) | 35 | Focused test target; consult suites for exercised boundaries. |
| [HexPersonality](HexPersonality.md) | 26 | Explicit profiles, personal facts and bounded prompt context. |
...
| [HexTests](HexTests.md) | 49 | Focused test target; consult suites for exercised boundaries. |
| [HexUITests](HexUITests.md) | 2 | Focused test target; consult suites for exercised boundaries. |

Total: **1252 Swift files** in **24 targets/directories**.
