...
| [HexGatewayKit](HexGatewayKit.md) | 79 | Resident composition, lifecycle, heartbeats and self-knowledge. |
| [HexGatewayTests](HexGatewayTests.md) | 38 | Focused test target; consult suites for exercised boundaries. |
...
| [HexMCPTests](HexMCPTests.md) | 26 | Focused test target; consult suites for exercised boundaries. |
...
| [HexTests](HexTests.md) | 52 | Focused test target; consult suites for exercised boundaries. |
| [HexUITests](HexUITests.md) | 2 | Focused test target; consult suites for exercised boundaries. |

Total: **1270 Swift files** in **24 targets/directories**.
