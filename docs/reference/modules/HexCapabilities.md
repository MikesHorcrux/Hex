...
## Packages/HexKit/Sources/HexCapabilities/Coding

| Source file | Leading source documentation |
| --- | --- |
| [CodingLegacyWriteTool.swift](../../../Packages/HexKit/Sources/HexCapabilities/Coding/CodingLegacyWriteTool.swift) | Retains the existing tool schemas and guarded file implementation while recording provenance. |
| [CodingWorkspaceManager+LegacyWrites.swift](../../../Packages/HexKit/Sources/HexCapabilities/Coding/CodingWorkspaceManager+LegacyWrites.swift) | — |
| [CodingWorkspaceManager+Preview.swift](../../../Packages/HexKit/Sources/HexCapabilities/Coding/CodingWorkspaceManager+Preview.swift) | — |
| [CodingWorkspaceManager+Reconciliation.swift](../../../Packages/HexKit/Sources/HexCapabilities/Coding/CodingWorkspaceManager+Reconciliation.swift) | — |
| [CodingWorkspaceManager.swift](../../../Packages/HexKit/Sources/HexCapabilities/Coding/CodingWorkspaceManager.swift) | — |
...
| [MacLocalURLControlling.swift](../../../Packages/HexKit/Sources/HexCapabilities/Mac/MacLocalURLControlling.swift) | Open an already validated loopback preview in one explicitly selected application. |
| [MacOpenLocalURLTool.swift](../../../Packages/HexKit/Sources/HexCapabilities/Mac/MacOpenLocalURLTool.swift) | Local development previews have a separate authorization surface from public web navigation. |
...
## Packages/HexKit/Sources/HexCapabilities/ProcessSessions

| Source file | Leading source documentation |
| --- | --- |
| [LiveProcessSession.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/LiveProcessSession.swift) | — |
| [ProcessOwnerLease.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessOwnerLease.swift) | — |
| [ProcessSessionErrorBridge.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionErrorBridge.swift) | — |
| [ProcessSessionManager+Controls.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionManager+Controls.swift) | — |
| [ProcessSessionManager.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionManager.swift) | — |
| [ProcessSessionSupervisor+Loop.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionSupervisor+Loop.swift) | — |
| [ProcessSessionSupervisor+Spawn.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionSupervisor+Spawn.swift) | — |
| [ProcessSessionSupervisor+TerminalChild.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionSupervisor+TerminalChild.swift) | — |
| [ProcessSessionSupervisor.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionSupervisor.swift) | Early executable mode: no resident, provider, database, UI, or Keychain initialization. Every child is spawned, never forked into a live Swift runtime. |
| [ProcessSessionTool.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSessionTool.swift) | — |
| [ProcessStartTool.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessStartTool.swift) | — |
| [ProcessSupervisorChild.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSupervisorChild.swift) | — |
| [ProcessSupervisorConnection.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSupervisorConnection.swift) | Actor owns the only writer. The manager pulls bounded output; no unbounded callback queue. |
| [ProcessSupervisorMessage.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSupervisorMessage.swift) | — |
| [ProcessSupervisorRequest.swift](../../../Packages/HexKit/Sources/HexCapabilities/ProcessSessions/ProcessSupervisorRequest.swift) | — |
...
| [WorkspaceDeletionResult.swift](../../../Packages/HexKit/Sources/HexCapabilities/Workspace/WorkspaceDeletionResult.swift) | — |
...
| [WorkspaceFileSystem+Delete.swift](../../../Packages/HexKit/Sources/HexCapabilities/Workspace/WorkspaceFileSystem+Delete.swift) | — |
