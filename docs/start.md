...
The current development checkout is the canonical `Hex` checkout on `dev`. Do not create a
second installed app to work around a connection problem. First inspect your branch and edits;
preserve existing work. General contributor isolation rules remain in [AGENTS](../AGENTS.md).
